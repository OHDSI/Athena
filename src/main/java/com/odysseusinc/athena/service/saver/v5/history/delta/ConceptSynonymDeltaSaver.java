...
@Service
public class ConceptSynonymDeltaSaver extends HistorySaver implements SaverV5Delta {
    ...
    protected String query() {
        ...
        return "SELECT * FROM get_concept_synonym_delta(:version, :versionDelta, :vocabularyArr, TRUE)";
    }
