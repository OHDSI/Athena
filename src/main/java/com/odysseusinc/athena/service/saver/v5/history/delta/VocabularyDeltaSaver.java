...
@Service
public class VocabularyDeltaSaver extends HistorySaver implements SaverV5Delta {
    ...
    protected String query() {
        ...
        return "SELECT * FROM get_vocabulary_delta(:version, :versionDelta, :vocabularyArr, TRUE)";
    }
}
