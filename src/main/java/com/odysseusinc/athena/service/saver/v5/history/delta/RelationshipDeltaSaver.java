...
@Service
public class RelationshipDeltaSaver extends HistorySaver implements SaverV5Delta {
    ...
    protected String query() {
        ...
        return "SELECT * FROM get_relationship_delta(:version, :versionDelta, :vocabularyArr, TRUE)";
    }
}
