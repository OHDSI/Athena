...
@Service
public class DrugStrengthSaver extends CSVSaver implements SaverV4, SaverV5 {
    ...
    protected String query() {
        ...
        return "SELECT drug_strength.* "
                + " FROM drug_strength INNER JOIN CONCEPT ON DRUG_CONCEPT_ID = CONCEPT_ID"
