...
public class AthenaUserToUserLicensesDTO implements Converter<AthenaUser, UserLicensesDTO>, InitializingBean {
    ...
    @Autowired
    public AthenaUserToUserLicensesDTO(GenericConversionService conversionService, ConverterUtils converterUtils) {
    ...
    @Override
    public UserLicensesDTO convert(AthenaUser user) {
